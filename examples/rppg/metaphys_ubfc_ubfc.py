...
if __name__ == "__main__":
    ...
    cfg = get_config("../../rppg/configs/FIT_METAPHYS_UBFC_UBFC.yaml")
    ...
    if cfg.fit.flag:
        ...
        if cfg.fit.meta.flag:
            ...
            dataset = data_loader(datasets=dataset,
                                  batch_sizes=[cfg.fit.train.batch_size],
                                  shuffles=[cfg.fit.train.shuffle],
                                  meta=cfg.fit.meta.flag)

        elif cfg.fit.train.flag and cfg.fit.val.flag and cfg.fit.test.flag:
