...
if __name__ == "__main__":
    ...
    cfg = get_config("../../rppg/configs/FIT_ContrastPhys_UBFC_UBFC.yaml")
    ...
    if cfg.fit.flag:
        ...
        model.load_state_dict(torch.load('../../rppg/pretrain_model/contrast_phys.pt'))
