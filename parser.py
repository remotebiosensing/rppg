...
if __name__ == '__main__':
    ...
    if args.train is True:
        ...
        train_model(args.model,models, train_loader, val_loader, loss_fn, opts, args.checkpoint_dir,
                    args.epochs, device)
    else:
        ...
        test_model(args.model,models, test_loader, loss_fn, opts, args.checkpoint_dir,
                   args.epochs, device)
